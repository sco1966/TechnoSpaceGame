...
class GameScene2: SKScene, SKPhysicsContactDelegate {
    ...
    //from Gspike
    let shade = "shader_water_movement.fsh"
    let shade2 = "shader_water_movement2.fsh"
    let shade3 = "shader_water_movement3.fsh"
    let shade4 = "shaderza.fsh"
    
    
    static var valuez: Int = 0
    ...
    override func didMove(to view: SKView) {
        ...
        // let shaderz = SKShader(fileNamed: "test.fsh")
        ...
        case 1:
            shaderz2(shade: shade4)
            GameScene2.valuez += 1
            for _ in 0..<10{
                spawnShip()}
            
        case 2:
            shaderz(shade: shade2)
            for _ in 0..<10{
                spawnShip()}
            
            
        default:
            print("Shader out of range")
        }
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if (counter == 20){
            //add here next shader (2) and also "items" after 10....
            
            
            
            //let scene = SKScene(fileNamed: "ContinueScreen")
             let scene = SKScene(fileNamed: "SectionOver")
    ...
    func nextStage(_ frameRate: TimeInterval){
        // print("ya")
        t = frameRate
        if (t > 1000){
            t = 0
